...
- Models: add Vertex AI Anthropic provider for Claude on GCP. Use your GCP credits directly with `vertex-anthropic/claude-opus-4-5@20251101`. Thanks @markbooch.
